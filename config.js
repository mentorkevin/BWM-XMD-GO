...
module.exports = {
    ...
    GURL: 'https://whatsapp.com/channel/0029VbBTYeRJP215nxFl4I0x/100',
    ...
    BOT_URL: process.env.BOT_URL ? process.env.BOT_URL.split(',') : [
        ...
        'https://res.cloudinary.com/dh5gg5p6a/image/upload/v1762017445/44fc16cf1a054e12b7b9014bcad2c385_dthtjt.jpg'
    ],
    ...
    FOOTER: process.env.BOT_FOOTER || '\n\nFor more info visit ₘᵧ ₚᵣₒᵳᵢₗₑ\n\n®2025 Cꫀׁׅܻᨵׁׅ 🔥',
    DATABASE_URL,
